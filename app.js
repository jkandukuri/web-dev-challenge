    ...
    .ready(function () {
        ...
        function addRecipesToDom(data) {
            ...
            data.map(function (recipe) {
                var appendReceipe = '<div class="card rounded" >'+ 
                    '<div class="card-image-overlay bg-transparent-dark"> ' +
                    '<a href="' + recipe.href + '" target="_blank" ><img class="card-img-top thumbnail" src="' + recipe.thumbnail + '" alt="Card image cap"><h5 class="card-title title-text-color ">' + recipe.title + '</h5></a>'+
